...
mixin _$PetModel implements DiagnosticableTreeMixin {
 ...
 int? get petId; String get name; String get breed; String get colour; PetSex get petSex; int? get age; DateTime? get dob; bool get dobEstimate; bool get dobCalculated; String? get diet; String? get notes; String? get history; bool get isNeutered; DateTime? get neuterDate; PetStatus get status; DateTime get statusDate; SpeciesModel get species; bool get isMicrochipped; DateTime? get microchipDate; String? get microchipNotes; String? get microchipNumber; String? get microchipCompany;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,petId,name,breed,colour,petSex,age,dob,dobEstimate,dobCalculated,diet,notes,history,isNeutered,neuterDate,status,statusDate,species,isMicrochipped,microchipDate,microchipNotes,microchipNumber,microchipCompany]);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'PetModel(petId: $petId, name: $name, breed: $breed, colour: $colour, petSex: $petSex, age: $age, dob: $dob, dobEstimate: $dobEstimate, dobCalculated: $dobCalculated, diet: $diet, notes: $notes, history: $history, isNeutered: $isNeutered, neuterDate: $neuterDate, status: $status, statusDate: $statusDate, species: $species, isMicrochipped: $isMicrochipped, microchipDate: $microchipDate, microchipNotes: $microchipNotes, microchipNumber: $microchipNumber, microchipCompany: $microchipCompany)';
}
...
@useResult
$Res call({
 int? petId, String name, String breed, String colour, PetSex petSex, int? age, DateTime? dob, bool dobEstimate, bool dobCalculated, String? diet, String? notes, String? history, bool isNeutered, DateTime? neuterDate, PetStatus status, DateTime statusDate, SpeciesModel species, bool isMicrochipped, DateTime? microchipDate, String? microchipNotes, String? microchipNumber, String? microchipCompany
});
...
as SpeciesModel,isMicrochipped: null == isMicrochipped ? _self.isMicrochipped : isMicrochipped // ignore: cast_nullable_to_non_nullable
