...
mixin _$PetModel implements DiagnosticableTreeMixin {
 ...
 int? get petId; String get name; String get breed; String get colour; PetSex get petSex; DateTime? get dob; bool get dobEstimate; String? get diet; String? get notes; String? get history; bool get isNeutered; DateTime? get neuterDate; PetStatus get status; DateTime get statusDate; SpeciesModel get species; bool get isMicrochipped; DateTime? get microchipDate; String? get microchipNotes; String? get microchipNumber; String? get microchipCompany;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,petId,name,breed,colour,petSex,dob,dobEstimate,diet,notes,history,isNeutered,neuterDate,status,statusDate,species,isMicrochipped,microchipDate,microchipNotes,microchipNumber,microchipCompany]);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'PetModel(petId: $petId, name: $name, breed: $breed, colour: $colour, petSex: $petSex, dob: $dob, dobEstimate: $dobEstimate, diet: $diet, notes: $notes, history: $history, isNeutered: $isNeutered, neuterDate: $neuterDate, status: $status, statusDate: $statusDate, species: $species, isMicrochipped: $isMicrochipped, microchipDate: $microchipDate, microchipNotes: $microchipNotes, microchipNumber: $microchipNumber, microchipCompany: $microchipCompany)';
}
