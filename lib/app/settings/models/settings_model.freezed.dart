...
mixin _$SettingsModel implements DiagnosticableTreeMixin {
 ...
 bool get acceptedTermsAndConditions; bool get optIntoAnalyticsWarning; bool get onBoardingComplete; String? get lastUsedVersion; WeightUnits? get defaultWeightUnit;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('acceptedTermsAndConditions', acceptedTermsAndConditions))..add(DiagnosticsProperty('optIntoAnalyticsWarning', optIntoAnalyticsWarning))..add(DiagnosticsProperty('onBoardingComplete', onBoardingComplete))..add(DiagnosticsProperty('lastUsedVersion', lastUsedVersion))..add(DiagnosticsProperty('defaultWeightUnit', defaultWeightUnit));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingsModel&&(identical(other.acceptedTermsAndConditions, acceptedTermsAndConditions) || other.acceptedTermsAndConditions == acceptedTermsAndConditions)&&(identical(other.optIntoAnalyticsWarning, optIntoAnalyticsWarning) || other.optIntoAnalyticsWarning == optIntoAnalyticsWarning)&&(identical(other.onBoardingComplete, onBoardingComplete) || other.onBoardingComplete == onBoardingComplete)&&(identical(other.lastUsedVersion, lastUsedVersion) || other.lastUsedVersion == lastUsedVersion)&&(identical(other.defaultWeightUnit, defaultWeightUnit) || other.defaultWeightUnit == defaultWeightUnit));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,acceptedTermsAndConditions,optIntoAnalyticsWarning,onBoardingComplete,lastUsedVersion,defaultWeightUnit);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'SettingsModel(acceptedTermsAndConditions: $acceptedTermsAndConditions, optIntoAnalyticsWarning: $optIntoAnalyticsWarning, onBoardingComplete: $onBoardingComplete, lastUsedVersion: $lastUsedVersion, defaultWeightUnit: $defaultWeightUnit)';
}
...
@useResult
$Res call({
 bool acceptedTermsAndConditions, bool optIntoAnalyticsWarning, bool onBoardingComplete, String? lastUsedVersion, WeightUnits? defaultWeightUnit
});
...
/// Create a copy of SettingsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? acceptedTermsAndConditions = null,Object? optIntoAnalyticsWarning = null,Object? onBoardingComplete = null,Object? lastUsedVersion = freezed,Object? defaultWeightUnit = freezed,}) {
...
class _SettingsModel with DiagnosticableTreeMixin implements SettingsModel {
  const _SettingsModel({required this.acceptedTermsAndConditions, required this.optIntoAnalyticsWarning, required this.onBoardingComplete, required this.lastUsedVersion, required this.defaultWeightUnit});
...
/// Create a copy of SettingsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? acceptedTermsAndConditions = null,Object? optIntoAnalyticsWarning = null,Object? onBoardingComplete = null,Object? lastUsedVersion = freezed,Object? defaultWeightUnit = freezed,}) {
