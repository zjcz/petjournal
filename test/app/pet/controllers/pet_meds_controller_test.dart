    ...
    group('save', () {
      testWidgets('Should call createPetMed When petMedId is null', (
        ...
        final initialPetMedModel = PetMedModel(
          ...
          frequency: initialPetMed.frequency,
          frequencyType: initialPetMed.frequencyType,
          doseUnit: initialPetMed.doseUnit,
          medType: initialPetMed.medType,
        ...
        when(
          mockDatabaseService.createPetMed(
            ...
            initialPetMedModel.frequency,
            initialPetMedModel.frequencyType,
            initialPetMedModel.doseUnit,
            initialPetMedModel.medType,
